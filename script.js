...
window.addEventListener('load', () => {
    ...
    if (footerText) {
        footerText.textContent = `© ${currentYear} Sathyamoorthy R. All rights reserved.`;
    }
});
...
const interactiveCards = document.querySelectorAll('.project-card, .achievement-card, .skill-category');
